      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-emerald-400/30 bg-linear-to-br from-emerald-500/10 to-emerald-600/5 p-8 transition hover:border-emerald-400/60 hover:shadow-lg hover:shadow-emerald-500/20"
          >
            <div className="absolute inset-0 bg-linear-to-r from-emerald-500/0 via-emerald-500/0 to-emerald-500/0 group-hover:via-emerald-500/10 transition" />
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-blue-400/30 bg-linear-to-br from-blue-500/10 to-blue-600/5 p-8 transition hover:border-blue-400/60 hover:shadow-lg hover:shadow-blue-500/20"
          >
            <div className="absolute inset-0 bg-linear-to-r from-blue-500/0 via-blue-500/0 to-blue-500/0 group-hover:via-blue-500/10 transition" />
            <div className="relative">
          ...
          <Link
            ...
            className="group relative overflow-hidden rounded-2xl border border-purple-400/30 bg-linear-to-br from-purple-500/10 to-purple-600/5 p-8 transition hover:border-purple-400/60 hover:shadow-lg hover:shadow-purple-500/20"
          >
            <div className="absolute inset-0 bg-linear-to-r from-purple-500/0 via-purple-500/0 to-purple-500/0 group-hover:via-purple-500/10 transition" />
            <div className="relative">
